...
export declare function mapWithConcurrency<T, R>(items: T[], maxConcurrency: number, worker: (item: T, index: number) => Promise<R>, resolveLimit: () => number, sleepFn?: (ms: number) => Promise<unknown>): Promise<R[]>;
export declare function fetchCandidateIssuesWithSummary(targets: FanoutTarget[], githubToken: string, options?: FanoutOptions): Promise<CandidateIssueSummary>;
/**
 ...
 * needed.
 */
export declare function fetchCandidateIssues(targets: FanoutTarget[], githubToken: string, options?: FanoutOptions): Promise<RawCandidateIssue[]>;
export declare function searchCandidateIssuesWithSummary(searchQuery: string, githubToken: string, options?: FanoutOptions): Promise<CandidateIssueSummary>;
export declare function searchCandidateIssues(searchQuery: string, githubToken: string, options?: FanoutOptions): Promise<RawCandidateIssue[]>;
