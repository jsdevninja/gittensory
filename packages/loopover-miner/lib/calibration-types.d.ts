...
export declare function isPredictedVerdictRecord(value: unknown): value is PredictedVerdictRecord;
export declare function isObservedOutcomeRecord(value: unknown): value is ObservedOutcomeRecord;
export declare function isCalibrationRow(value: unknown): value is CalibrationRow;
export declare function isCalibrationReport(value: unknown): value is CalibrationReport;
